...
class BookServiceIntegrationTest {
    ...
    @Test
    fun `should return pre-populated books`() {
        // When
    ...
    @Test
    fun `should create and return new book`() {
        // Given
        val newBook = Book(
    ...
    @Test
    fun `should return recommendation for existing genre`() {
        // When
    ...
    @Test
    fun `should return recommendation without genre parameter`() {
        // When
        val response = restTemplate.getForEntity(
    ...
    @Test
    fun `should return 404 for non-existent genre`() {
        // When
        val response = restTemplate.getForEntity(
    ...
    @Test
    fun `should handle complete book lifecycle`() {
        ...
        val createResponse = restTemplate.postForEntity("${baseUrl()}/books", createRequest, Book::class.java)
        createResponse.statusCode shouldBe HttpStatus.CREATED
        val savedBook = createResponse.body!!

        // Step 3: Verify book count increased
        val afterCreateResponse = restTemplate.getForEntity("${baseUrl()}/books", Array<Book>::class.java)
    ...
    @Test
    fun `should handle missing content type`() {
        // Given
